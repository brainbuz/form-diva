...
Catalyst, Mojolicious and Dancer are frameworks for creating web applications you should use one of them. 

Form::Diva is meant to be used with a Templating System, Template::Alloy is compatible with Template::Toolkit, Mojo::Template is a Perl reimplemenation of ERB.
